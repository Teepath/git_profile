...
var token = "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";

function myFunction() {
  var username = document.getElementById("search_term").value; // document.getElementById("result").innerHTML = username;
